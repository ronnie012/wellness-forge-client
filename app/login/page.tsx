...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="bg-white dark:bg-gray-800 px-8 py-24 rounded-lg shadow-md w-full max-w-lg text-center">
        <h1 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Welcome Back!</h1>
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">Sign in to access your wellness dashboard.</p>
        <button
